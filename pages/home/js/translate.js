const langObj = {
    'en': {
        ...
        'section-tools-subtitle1': 'Discussion',
        'section-tools-subtitle2': 'Health plan',
        'section-tools-subtitle3': 'Follow-up care',
        ...
        'tools-text-discussion2': 'Specify your health issue and answer a few questions about your health history. So that the doctor can understand your needs and create an appropriate treatment plan for you.',
        'tools-text-health': 'Healthcare professional will evaluate your symptoms and discuss an personalized treatment plan with you.',
        'tools-text-span1': 'E-prescriptions',
        'tools-text-span2': 'Recommendations',
        'tools-text-span3': 'E-refferrals',
        'tools-text-follow': 'Set personal health goals and monitor your progress. Your healthcare medical specialist  on the Letmed platform is here to help if treatment is going wrong.',
